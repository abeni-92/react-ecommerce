...
function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen">
      <aside className="relative bg-[#1C2434] flex flex-col gap-10 min-w-80 w-auto py-8 px-12">
        ...
        <ul className="flex flex-col mt-10 gap-10 text-white justify-center items-start">
          <li>
            <a href="#" className="flex gap-6 font-semibold">
              <svg
          ...
          <li>
            <a href="#" className="flex gap-6 font-semibold text-orange-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512"
